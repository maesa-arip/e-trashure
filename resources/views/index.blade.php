...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>
      E-Trashure | Efficient Waste Management for a Cleaner Tomorrow
    </title>
    <link
      rel="shortcut icon"
  ...
  <body>
          ...
          <div class="max-w-full px-4 w-60">
            <a href="index.html" class="block w-full py-5 navbar-logo">
              <img
                ...
                alt="logo"
                class="w-full h-12 header-logo" style="
                height: 50px;
                width: auto;
            "
              />
    ...
    <section class="pb-8 pt-20 dark:bg-dark lg:pb-[70px] lg:pt-[120px]">
      <div class="container">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-12 text-center lg:mb-[70px]">
              ...
              <p class="text-base text-body-color dark:text-dark-6">
                Peduli lingkungan adalah investasi untuk masa depan yang lebih hijau dan berkelanjutan. Mari bersatu untuk merawat alam, karena rumah kita bersama adalah bumi yang perlu kita jaga dengan penuh cinta dan tanggung jawab
              </p>
            </div>
          </div>
        </div>
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="mb-12 wow fadeInUp group" data-wow-delay=".1s">
              ...
              <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                Memberikan pemahaman kepada masyarakat tentang pentingnya pengelolaan sampah yang baik dan pengurangan penggunaan plastik sekali pakai.
              </p>
              <a
                href="javascript:void(0)"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="mb-12 wow fadeInUp group" data-wow-delay=".15s">
              ...
              <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                Membangun infrastruktur pengelolaan sampah yang efisien, termasuk sistem pengumpulan, pemilahan, daur ulang, dan pembuangan yang aman.
              </p>
              <a
                href="javascript:void(0)"
                class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="mb-12 wow fadeInUp group" data-wow-delay=".2s">
              ...
              <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                Menerapkan kebijakan yang mendukung pengurangan sampah, seperti pembatasan penggunaan plastik, insentif bagi industri yang ramah lingkungan, dan larangan pembuangan sampah sembarangan.
              </p>
              <a
                href="javascript:void(0)"
                class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="mb-12 wow fadeInUp group" data-wow-delay=".25s">
              ...
              <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                Mendorong inovasi dalam pengelolaan sampah, seperti teknologi daur ulang yang canggih, produk ramah lingkungan, dan solusi alternatif untuk pengemasan.
              </p>
              <a
                href="javascript:void(0)"
                class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
          ...
          <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4 lg:w-1/2">
              <div class="mb-12 max-w-[540px] lg:mb-0">
                ...
                >
                  Ide Brilian Untuk Melindungi Lingkungan Sambil Menghasilkan Cuan
                </h2>
                <p
                  class="mb-10 text-base leading-relaxed text-body-color dark:text-dark-6"
                >
                Pilah sampah adalah langkah sederhana namun berdampak besar dalam menjaga kebersihan dan kelestarian lingkungan. Dengan memisahkan sampah organik, non-organik, dan daur ulang, kita membantu mengurangi pencemaran lingkungan dan memperpanjang umur pakai bahan-bahan yang dapat didaur ulang.
                  <br />
                  <br />
                ...
                <a
                  href="javascript:void(0)"
                  class="inline-flex items-center justify-center py-3 text-base font-medium text-center text-white border rounded-md border-primary bg-primary px-7 hover:border-teal-dark hover:bg-teal-dark"
                >
                  Pelajari
                </a>
              </div>
          ...
          <div class="flex flex-wrap items-stretch -mx-4">
            <div class="w-full px-4">
              <div class="mx-auto max-w-[570px] text-center">
                ...
                >
                  <span>Apalagi Yang Kamu Cari ?</span>
                  <br>
        ...
        <div class="flex flex-wrap justify-center -mx-4">
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <a
                href="javascript:void(0)"
                class="inline-block py-3 text-base font-medium text-center text-white transition rounded-md bg-primary px-7 hover:bg-teal-dark"
              >
                Purchase Now
              </a>
            </div>
        ...
        <div class="flex flex-wrap justify-center -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[485px] text-center">
              ...
              >
                Apa yang dikatakan para pengguna kami
              </h2>
              <p class="text-base text-body-color dark:text-dark-6">
                There are many variations of passages of Lorem Ipsum available
                but the majority have suffered alteration in some form.
    ...
    <!-- ====== Blog Section Start -->
    <section id="participant" class="bg-white pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
      <div class="container mx-auto">
        <div class="flex flex-wrap justify-center -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[485px] text-center">
              ...
              <p class="text-base text-body-color dark:text-dark-6">
                Mengajak partisipasi aktif masyarakat dalam program pengelolaan sampah, seperti kegiatan pembersihan lingkungan, kampanye pengurangan sampah, dan pengelolaan komunitas.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <form>
                ...
                <div class="mb-0">
                  <button
                    type="submit"
                    class="inline-flex items-center justify-center px-10 py-3 text-base font-medium text-white transition duration-300 ease-in-out rounded-md bg-primary hover:bg-teal-dark"
                  >
                    Send
                  </button>
                </div>
